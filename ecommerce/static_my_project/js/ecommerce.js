    ...
    select_color_sizes.on('change' ,function(){
            ...
            for (var i in my_colors_array){
                ...
                switch (my_colors_array[i]){
                    ...
                    case 'pink':
                        str_colors+="<li class='color-list__item color-list__item--pink'></li>"
                }
            }
...
var FilterBy = $('.FilterBy')   // form class name
    ...
    FilterBy.on('change',function () {
        $FilterBythis = $(this)
        // alert($FilterBythis.attr("action"))
        var brand =""
        ...
        var PriceFrom=FilterBy.find("[name='PriceFrom']").val()
        var PriceTo=FilterBy.find("[name='PriceTo']").val()
...
// var col_filter_price_div = $('#col-filter-price')
//    var Proceform= col_filter_price_div.find("[name='PriceFrom']")
//
//
//     Proceform.keyup(function () {
//         $this=$(this)
//         alert($this.val())
//     })
